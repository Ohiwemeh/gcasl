        ...
        <form  onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            id='name'
             ...
             placeholder="Enter your full name" className="w-full px-4 py-2 border rounded outline-none" />
          </div>
          {/* <div>
          ...
          <div>
            ...
            id='email'
             ...
             placeholder="Enter your email" className="w-full px-4 py-2 border rounded outline-none" 
            />
          </div>
          <div>
            ...
            id='password'
              ...
              placeholder="Create a password" className="w-full px-4 py-2 border rounded outline-none" />
          </div>
          <div>
            ...
            id='confirmPassword'
             ...
             placeholder="Confirm your password" className="w-full px-4 py-2 border rounded outline-none" />
          </div>
